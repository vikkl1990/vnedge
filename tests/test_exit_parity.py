...
Scanner observer lanes additionally use ``execution.exit_engine`` directly,
so their replay and shadow paths never cross this legacy runtime boundary.
"""

from __future__ import annotations

from vnedge.execution.exit_engine import ExitConfig
from vnedge.execution.exit_engine import ExitEngine as ResearchExit
...
def test_ladders_are_expressed_in_different_units() -> None:
    ...
    reason, _price = _drive_research(research, [(103.0, 100.0, 102.9)])
